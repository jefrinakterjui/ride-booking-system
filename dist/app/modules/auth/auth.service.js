...
const creadentialLogin = (paylode) => __awaiter(void 0, void 0, void 0, function* () {
    if (!paylode) {
        throw new AppError_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, "No data provided in request body");
    }
